...
export const mockProjects: Project[] = [
  {
    ...
    languages: [
      { source: 'EN', target: 'ES', service: 'Subtitling' },
      { source: 'EN', target: 'FR', service: 'Subtitling' },
      { source: 'EN', target: 'DE', service: 'Dubbing' },
    ],
    taskCount: 24,
    completedTasks: 16,
    quoteId: 'q2',
  ...
  },
  {
    ...
    pm: 'Mike Manager',
    pmId: '2',
    services: ['Dubbing', 'Mixing', 'Subtitling'],
    languages: [
      { source: 'EN', target: 'ES', service: 'Dubbing' },
      { source: 'EN', target: 'PT', service: 'Subtitling' },
    ],
    taskCount: 48,
    completedTasks: 12,
  ...
  },
  {
    ...
    pm: 'Sarah Admin',
    pmId: '1',
    services: ['Subtitling', 'Closed Captions'],
    languages: [
      { source: 'EN', target: 'ES', service: 'Subtitling' },
      { source: 'EN', target: 'FR', service: 'Closed Captions' },
    ],
    taskCount: 18,
    completedTasks: 17,
  ...
  },
  {
    ...
    pm: 'Mike Manager',
    pmId: '2',
    services: ['Dubbing', 'Subtitling', 'QC', 'Mixing'],
    languages: [
      { source: 'EN', target: 'ES', service: 'Dubbing' },
      { source: 'EN', target: 'DE', service: 'Dubbing' },
      { source: 'EN', target: 'FR', service: 'Subtitling' },
  ...
  },
  {
    ...
    languages: [
      { source: 'EN', target: 'JA', service: 'Subtitling' },
      { source: 'EN', target: 'KO', service: 'Dubbing' },
    ],
    taskCount: 20,
    completedTasks: 20,
