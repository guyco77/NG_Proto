...
import { Plus, Trash2, Save, AlertCircle, DollarSign } from 'lucide-react'
...
export default function PricingConfigurationPage() {
  ...
  const handleSaveVideoRate = (rate: VideoMinuteRate) => {
    ...
    toast({ title: 'Video rate updated', description: 'Changes will apply to new projects only.' })
  }
  ...
  const handleAddTranslationRate = () => {
    ...
    toast({ title: 'Rate added', description: 'Translation rate card entry has been added.' })
  }
    ...
    <div className="p-6 lg:p-8 space-y-6 max-w-5xl">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Configure default rates for video minutes and translation language pairs
        </p>
      </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Premium rate for specialized content"
                    className="mt-1 h-9 w-full rounded-lg border border-input bg-background px-3 text-sm"
                  />
                </div>
              </div>
